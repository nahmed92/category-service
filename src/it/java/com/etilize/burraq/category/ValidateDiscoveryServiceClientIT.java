...
/**
 * This class contains test case to verify Discovery Service Client's Integration.
 * In order to execute this case successfully, the following property need to be added in service's
 * application.yml on stage OR local machine:
 *  endpoints:
 *    metrics:
 *      sensitive: false
 * @author Nimra Inam
